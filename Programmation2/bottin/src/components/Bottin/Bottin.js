...
export class Bottin extends React.Component {
    ...
    btnEffacer(){
        return(
        <Button variant="outline-success" className="ml-1" type="button" onClick={this.btnEffacer}>Effacer</Button>
        )
    ...
    listeEmployes() {
            ...
            return  (<Row>
                {tabEmployes.map((element,i) => element.nom.toLowerCase().includes(this.state.rechercher.toLowerCase()) &&
